...
module.exports = function ozel() {
  ...
  try {
    ...
    const veri = { surum: 1, sihirbaz: true, fark: { renk: { blue: '#123456' }, yogunluk: 1.1 } };
    ...
    L.ok('an invalid colour is refused', S.istek('POST', '/ozel-ayar', JSON.stringify({ fark: { renk: { blue: 'red' } } }), b).status === 400);
