...
const PANELLER = [
  ['metin', 'Genel Metin', [
    ...
    ['Bölüm başlığı', 'renk-1', null, 5, true],
    ['Kahraman başlık', 'renk-1', null, 2, true],
    ['Kod ve mono yazı', 'renk-2-text', null, 4],
    ['Uyarı yazısı', 'warning', null, 2],
    ['Tehlike yazısı', 'danger-text', null, 2],
  ]],
  ['dugme', 'Düğmeler', [
    ['Birincil düğme', 'on:renk-1', 'renk-1', 8],
    ['Hayalet düğme', 'text', null, 7],
    ['Hayalet düğme üstünde', 'on:renk-3-10', 'renk-3-10', 3],
    ['Tehlike düğmesi', 'on:danger-text', 'danger-text', 2],
    ['Simge düğmesi üstünde', 'renk-2-text', 'renk-2-10', 2],
  ...
  ['ust', 'Üst Çubuk', [
    ...
    ['Ad vurgusu', 'renk-2-text', 'surface', 3],
    ['Sekme', 'renk-1', 'surface', 8],
    ['Sekme üstünde', 'renk-2-text', 'surface', 2],
    ['Çip', 'renk-1', 'surface', 3],
    ['Destek çipi', 'renk-3-text', 'surface', 2],
    ['Pencere düğmesi üstünde', 'on:renk-3-30', 'renk-3-30', 1],
  ...
  ['kurulum', 'Kurulum Paneli', [
    ...
    ['Başlık vurgusu', 'renk-2-text', 'surface', 2],
    ['Alt yazı', 'disabled', 'surface', 3],
    ['Yüzde', 'renk-1', 'surface', 3],
    ['Günlük satırları', 'disabled', 'surface', 5],
    ['Son günlük satırı', 'renk-1', 'surface', 3],
